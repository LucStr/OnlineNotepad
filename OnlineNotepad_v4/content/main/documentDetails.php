<?php
  ...
  $document = $db->getDocumentsById($_GET['documentId']);
  ...
  if(mysql_num_rows($result)==0 && $userId !== $documentOwnerId){
...
if($userId === $documentOwnerId){
  ?>
  <a href="?menu=mManagePermissions&documentId=<?=$documentId?>">Manage permissions</a>
  <a href="?action=aDeleteDocument&documentId=<?=$documentId?>">Delete document</a>
<?php
 }
 ?>
